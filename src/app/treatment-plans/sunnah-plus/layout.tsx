...
export const metadata: Metadata = {
  title:
    "Sunnah Plus Therapy – Full-Body Cupping for Pain, PMS, Skin Issues & Stress Relief",
  description:
  ...
  openGraph: {
    ...
    description:
      "Discover the Sunnah Plus plan at i-Revive – a powerful Hijama therapy covering 9 key points with deep tissue stroke and gliding cupping. Ideal for back pain, migraines, arthritis, skin issues, PMS, and more in Hyderabad.",
    url: "https://www.i-revive.com/treatment-plans/sunnah-plus",
    images: [
      {
  ...
  alternates: {
    canonical: "https://www.i-revive.com/treatment-plans/sunnah-plus",
  },
  other: {
