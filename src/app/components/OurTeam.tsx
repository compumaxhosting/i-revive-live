          ...
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
              {teamMembers.map((member) => (
                ...
                >
                  <div className="group relative bg-white hover:rounded-none rounded-2xl overflow-hidden shadow-lg hover:shadow-none border border-gray-200 border-b-gray-300 md:border-gray-300 md:border-b-gray-400 h-full transition-all">
                    {/* Image */}
