...
export const metadata: Metadata = {
  ...
  "what happens under the cups",
  "cupping therapy benefits",
  "stagnant blood removal",
  "detox with cupping",
  "cupping therapy for health",
  "environmental toxins cupping",
  "metabolic waste removal",
  "natural cupping healing",
  "i-Revive cupping Hyderabad"
],
